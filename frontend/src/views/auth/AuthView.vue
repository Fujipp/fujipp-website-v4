...
const ICONS = {
  ...
  discord:  '/images/icons/auth/ic_baseline-discord.svg',
  google:   '/images/icons/auth/flat-color-icons_google.svg',
  eyeOpen:  '/images/icons/auth/mdi_eye.svg',
  eyeClose: '/images/icons/auth/mingcute_eye-close-fill.svg',
  question: '/images/icons/auth/Mingcute Question Fill.svg',
} as const
