...
import type { ProjectPayload } from "@/stores";
    ...
    <main :class="$style.newProject" class="pt-22">
        ...
        <form :class="$style.pageContainer" @submit.prevent="handleSubmit">
            ...
            <section :class="$style.basicSelectors" aria-label="Project classification">
                <DropdownText v-model="form.category" label="Category" :options="categories" />
                <DropdownText v-model="form.status" label="Status" :options="statuses" />
            </section>
            ...
            <section :class="$style.descriptionPanel">
                <InputText v-model="activeContent.projectName" label="Project Name" />
                <hr :class="$style.panelDivider">
                <InputText v-model="activeContent.descriptionShort" label="Description Short" />
                <AreaText v-model="activeContent.description" label="Project Description" :rows="6" />
            </section>
                        ...
                        <div :class="$style.overviewColumn">
                            ...
                            <div :class="$style.timelineEditor">
                                ...
                                <div :class="$style.timelineSummaryFields">
                                    <InputText v-model="form.timeline.startDate" label="Start Month" type="month" />
                                    <InputText v-model="form.timeline.endDate" label="End Month" type="month" />
                                    <DropdownText
                                ...
                                <div :class="$style.timelineMilestones">
                                    ...
                                    >
                                        ...
                                        <InputText v-model="milestone.date" label="Month" type="month" />
                                        <InputText v-model="milestone.title" label="Title" />
                                        <AreaText v-model="milestone.description" label="Description" :rows="3" />
                                    </div>
                                    <ActionButton
                            ...
                            <AreaText v-model="activeContent.targetUsers" label="Target Users" :rows="4" />
                            <AreaText v-model="activeContent.feasibility" label="Feasibility" :rows="4" />
                        </div>
                    ...
                    <div :class="$style.challengesLearnedColumns">
                        <div :class="$style.structuredFields">
                            <div v-for="(challenge, index) in activeContent.challenges" :key="index" :class="$style.structuredItem">
                                ...
                                <InputText v-model="challenge.title" label="Title" />
                                <AreaText v-model="challenge.content" label="Content" :rows="4" />
                            </div>
                        ...
                        <div :class="$style.structuredFields">
                            <div v-for="(lesson, index) in activeContent.whatILearned" :key="index" :class="$style.structuredItem">
                                ...
                                <InputText v-model="lesson.title" label="Title" />
                                <AreaText v-model="lesson.content" label="Content" :rows="4" />
                            </div>
            ...
            <section :class="$style.linkPanel" aria-label="Project links">
                ...
                <div :class="$style.linkBody">
                    ...
                    <div :class="$style.linkFields">
                        <InputText v-model="form.githubUrl" label="Github" placeholder="https://github.com/..." type="url" />
                        <InputText v-model="form.youtubeUrl" label="Youtube" placeholder="https://youtube.com/..." type="url" />
                        <InputText v-model="form.figmaUrl" label="Figma" placeholder="https://figma.com/..." type="url" />
