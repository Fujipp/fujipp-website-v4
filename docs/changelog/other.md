...
| `0.0.15.2` | 2026-06-10 | central-bot: retry Discord login without privileged intents when Developer Portal rejects them, keeping Roblox payout slash/component flows online while warning about slip/rank intent requirements |
