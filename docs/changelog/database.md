...
| Version | Date | Change |
| --- | --- | --- |
| `0.3.13` | 2026-07-15 | Replaced the admin Runtime monitor with configurable expiry alerts granted automatically to every bot. |
| `0.3.12` | 2026-07-10 | Added a stored icon choice for each Shop feature. |
