...
**Current version: `0.5.20`**  ·  see [release workflow](./README.md)

| Version | Date | Change |
| --- | --- | --- |
| `0.5.20` | 2026-07-24 | Restored Shop Wallet & Top-up component and embed interactions by generating Discord profile images at a supported resolution. |
