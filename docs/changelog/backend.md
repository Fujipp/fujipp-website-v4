...
| Version | Date | Change |
| --- | --- | --- |
| `0.5.12` | 2026-07-24 | Added an emergency payment-method fallback that bypasses configurable templates when either Wallet or Roblox top-up response construction fails, while logging the original runtime error for diagnosis. |
