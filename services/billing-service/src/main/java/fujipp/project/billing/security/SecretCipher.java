package fujipp.project.billing.security;
...
/**
 * AES-256-GCM for customer secrets stored in feature_config_values.
 *
 ...
 * Mirrors the backend SecretCipher; key (BOT_SECRET_KEY) is 32 bytes as hex or base64.
 */
@Component
